...
static NSString * const consumerKey = @"IuRIWnbLO17eqNiS1QOO7HUQa"; // Enter your consumer key here
static NSString * const consumerSecret = @"gct9SqIMVLVrEqu2F08VpXXhCsbdRqSrsw4pOfyPREH6by6fNJ"; // Enter your consumer secret here
...
- (void)loadMoreHomeLineBefore: (NSString*) id completion: (void(^)(NSArray *tweets, NSError *error))completion {
    NSDictionary *parameters = @{@"max_id":id};
    [self GET:@"1.1/statuses/home_timeline.json"
...
- (void)replyWithText:(NSString *)text toTweet:(Tweet *)tweet completion:(void (^)(Tweet *, NSError *))completion{
    ...
    NSString *statusText = [NSString stringWithFormat: @"@%@ %@",tweet.user.screenName, text];
    NSDictionary *parameters = @{@"status": statusText, @"in_reply_to_status_id":tweet.idStr};
